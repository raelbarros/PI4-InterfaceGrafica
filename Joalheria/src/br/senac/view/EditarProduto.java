...
public class EditarProduto extends javax.swing.JFrame {
    ...
    public EditarProduto() {
        ...
        imgAux = ManipularImagem.getImgBytes(imagem);
    ...
    private void initComponents() {
        ...
        jsQuantidade.setModel(new javax.swing.SpinnerNumberModel(0, null, 500, 1));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informações do Produto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 11))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jcSegmento, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lblTamanho)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtTamanho, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jcCategoria, 0, 97, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtMaterial, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))
        ...
        jpNovoProdutoLayout.setVerticalGroup(
            jpNovoProdutoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jpNovoProdutoLayout.createSequentialGroup()
                .addGroup(jpNovoProdutoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jpNovoProdutoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jsQuantidade, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            CategoriaProduto c = ServicoDaoCategoria.getIstance().pegaCategoriaById(produtoEdicao.getIdCategoria());
            TipoSegmento segmento = TipoSegmento.getEnum(produtoEdicao.getSegmento());

            txtNome.setText(produtoEdicao.getNome());
            txtMarca.setText(produtoEdicao.getMarca());
            txtMaterial.setText(produtoEdicao.getMaterial());
            txtTamanho.setText(produtoEdicao.getTamanho());
            jcSegmento.setSelectedItem(segmento.toString());
            jcCategoria.setSelectedItem(c.getNome());
            jsQuantidade.setValue(produtoEdicao.getQuant());
            txtPreco.setValue(produtoEdicao.getPrecoUni());
            txtCodigo.setValue(produtoEdicao.getCodigo());

            imgAux = produtoEdicao.getImg();
            ManipularImagem.exibiImagemLabel(produtoEdicao.getImg(), lblImg);

            produtoId = produtoEdicao.getIdProduto();
        } catch (Exception e) {
        }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        newProduto.setIdProduto(produtoId);
        ...
        try {
            ...
            ServicoDaoProduto.getIstance().updateProduto(newProduto);
